...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/holo.png" alt="HackTheBox saison 4" style="max-width: 100%; border-radius: 10px;" >
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/beginner.png" alt="Beginner Learning Path" style="max-width: 100%; border-radius: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/jr.png" alt="Jr Penetration Tester Learning Path" style="max-width: 100%; border-radius: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/red.png" alt="Red Teaming Learning Path" style="max-width: 100%; border-radius: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/web.png" alt="Web Fundamentals Learning Path" style="max-width: 100%; border-radius: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/comptia.png" alt="CompTIA Pentest+ Learning Path" style="max-width: 100%; border-radius: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/intro.png" alt="Introduction to Cyber Security Learning " style="max-width: 100%; border-radius: 10px;">
  ...
  <div style="background-color: #1c1c1c; border-radius: 10px; padding: 20px; width: 30%; margin: 10px; color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">
    <img src="/assets/trophies/presecur.png" alt="Pre Security Learning Path" style="max-width: 100%; border-radius: 10px ">
